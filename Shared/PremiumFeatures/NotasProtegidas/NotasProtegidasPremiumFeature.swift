...
private enum NotasProtegidasPremiumScreenshot: String, PremiumFeatureScreenshotName {
    case overview = "notas_protegidas_premium_1"
    case security = "notas_protegidas_premium_2"
    case content = "notas_protegidas_premium_3"
}
...
extension PremiumFeaturePresentation {
    static var protectedNotes: Self {
        .localized(
            ...
            screenshotNames: NotasProtegidasPremiumScreenshot.orderedNames
        )
    }
}
#endif
