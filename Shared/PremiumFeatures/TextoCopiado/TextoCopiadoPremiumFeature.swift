...
private enum TextoCopiadoPremiumScreenshot: String, PremiumFeatureScreenshotName {
    case overview = "texto_copiado_premium_1"
    case actions = "texto_copiado_premium_2"
    case result = "texto_copiado_premium_3"
}
...
extension PremiumFeaturePresentation {
    static var smartCopiedText: Self {
        .localized(
            ...
            screenshotNames: TextoCopiadoPremiumScreenshot.orderedNames
        )
    }
}
#endif
