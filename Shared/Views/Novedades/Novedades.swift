                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 20){
                        ...
                        VStack(alignment: .leading, spacing: 20){
                            ...
                            Text("☘️ Varias correcciones y mejoras en Frases. Ahora es posible editar las frases personales")
                            Text("☘️ Nuevo en Diario: Se ha añadido una opción en Ajustes para mantener el Diario desbloqueado mientra este la app abierta. Esto evita tener que pasar la validación en cada acceso al Diario")
                            ...
                            Text("☘️ Varias mejoras y correcciones en Reflexiones. Ahora es posible editar las reflexiones. también se ha mejorado la representación de las mismas")
                            ...
                            Text("☘️ IA: Se han revisado y afinado los ajustes que controlan las respuestas de la IA. Ahora es más natural y fluida. Además, se ha enriquecido el conocimiento base con más información sobre las enseñanzas de neville")
