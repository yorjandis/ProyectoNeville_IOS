...
#ifndef SHAREDIOS_SWIFT_H
#define SHAREDIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="sharedios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC9sharedios12BaseTextView")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC9sharedios19ShareViewController")
